...
// pistatusline: widgets whose data does not exist in pi are left out: output-style, claude-account-email, claude-status, sandbox-status, skills, vim-mode, voice-status, remote-control-status, block-timer, worktree-mode, worktree-name, worktree-branch, worktree-original-branch, cache-timer.
